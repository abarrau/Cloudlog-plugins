<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="contest_list_table" class="table table-sm table-striped">
                <thead>
                    <tr>
                ...
                <tbody>
                   ...
                   ?>
                    <tr>
                        <td style="width:35%;"><?php echo $row['contest_name']; //echo "<br/><span style=\"font-size:80%;font-style:italic;\">(".((isset($row['contest_cl_n']))?$row['contest_cl_n']:'').")</span>"; ?></td>
                        ...
                        <td style=""><?php echo (isset($row['contest_qso_nb']))?$row['contest_qso_nb']:'-'; ?></td>
                        
                        <td style="text-align:right;">
                            <? if (!isset($row['is_error'])) { 
                                echo "<a href=\"".$pluginsext_url2menu."/list_qso/".$row['pluginsdata_id']."\" class=\"btn btn-primary btn-sm\" title=\"QSO List\"><i class=\"fas fa-list\"></i></a>";
                                echo "&nbsp;&nbsp;<a href=\"".$pluginsext_url2menu."/update/".$row['pluginsdata_id']."\" class=\"btn btn-primary btn-sm\" title=\"Edit\"><i class=\"fas fa-edit\"></i></a>";
                            }
                            echo "&nbsp;&nbsp;<a href=\"javascript:contest_delete_confirm(".$row['pluginsdata_id'].");\" class=\"btn btn-outline-danger btn-sm\" title=\"".$this->lang->line('pluginsext_delete')."\"><i class=\"fas fa-trash-alt\"></i></a>";
                            ?>
                        </td>
                    </tr>
                    <?php } ?>
