<div class="form-row">
    ...
    <div class="card col-md-4" style="padding:0px!important;">
        ...
        <div class="card-body">
            <div class="form-row">
                <div class="col-sm-8"><?php echo $this->lang->line('contest_nb_qso')." (".$this->lang->line('pluginsext_validate')."/".$this->lang->line('pluginsext_total').")"; ?> :</div>
                <div class="col-sm-4"><?php echo "<span class=\"contest_listinfo_nbv\">".$pluginsdata_data['list_info']['nbv']."</span> / ".$pluginsdata_data['list_info']['nb']; ?></div>
            </div>
            <div class="form-row">
                <div class="col-sm-8"><?php echo $this->lang->line('contest_period_activity'); ?> :</div>
            ...
            <table id="contest_list_qso_table" class="table table-sm table-striped contacttable table-hover">
                ...
                <tbody>
                    ...
                    <tr class="contest_qso_one" data-qsoid="<?php echo $row->COL_PRIMARY_KEY; ?>" >
                        ...
                        <td><span style="display:none;"><?php echo $row->COL_DISTANCE; ?></span><?php echo $row->COL_DISTANCE.' '.$pluginsdata_data['measurement_base']; ?></td>
